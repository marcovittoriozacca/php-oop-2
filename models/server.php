<?php
    ...
    //collare per cani rosso
    $collarePerCani = new Product($dog, 'Collare per cani', 'Collare con guinzaglio per cani', 'https://arcaplanet.vtexassets.com/arquivos/ids/285097/f4aa02d5b9f70bd3530dacebd540ce9fee823a1b_63001c39bfdccc7ced6207466a692521fd4f09ca--1-.jpg?v=638192236899730000', 15.99, 23);
    try{
        $collarePerCani->setColor('red');
    }catch(Exception $e) {
        echo "Errore: " . $e->getMessage();
    }

    //topino di pezza per gatti
    ...
    try{
        $topoDiPezzaGatto->setColor("gray | white | black");
    }catch(Exception $e) {
        echo "Errore: " . $e->getMessage();
    }
    ...
    try{
        $cucciaLgPerCani->setColor('white & lightgray');
    }catch(Exception $e) {
        echo "Errore: " . $e->getMessage();
    }
